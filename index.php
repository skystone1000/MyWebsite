        ...
        <div class="container">
            ...
            <div class="row wow fadeIn">
                ...
                <div class="col-md-6 mb-4 white-text text-center text-md-left">
                    <h1 class="display-4 font-weight-bold">Hello There <br>Aditya Mahajan Here... !!!</h1>
                    <hr class="hr-light">
                    <p>
                    ...
                    <div class="card trans-card z-depth-5">
                        ...
                        <div class="intrests card-body">
                            ...
                            <form name="" class="white-text opacity-50 ">
                                ...
                                <hr>
                                <ul>
                                    <li>Coding (Mostly in C++ and Python) <i class="fa fa-code"></i></li>
                                </ul>
                                <ul>
                                ...
                                <ul>
                                    <li>Cooking <i class="fa fa-cutlery" aria-hidden="true"></i></li>
                                </ul>
                                <ul>
                                    <li>Travelling</li>
                                </ul>
